CREATE OR REPLACE PROCEDURE CDM.test7  AS 
 BEGIN NULL;
htp.prn('¿');
htp.prn('
');
...
<head>
    ...
    <link rel="stylesheet" href="/i/css/posterous.css" type="text/css" />
    ...
    <script type="text/javascript">
      ...
      <script type="text/javascript">
          ...
          function initialize() {
              ...
              query1 = new google.visualization.Query(''http://fraterno/cdm_dad/gdatasource2.get_json?p_datasource_id=gauge'');
              query1.setRefreshInterval(10);
              query1.send(drawVisualization1);
              query2 = new google.visualization.Query(''http://fraterno/cdm_dad/gdatasource2.get_json?p_datasource_id=dae'');
              query2.setRefreshInterval(10);
              query2.send(drawVisualization2);
              query3 = new google.visualization.Query(''http://fraterno/cdm_dad/gdatasource2.get_json?p_datasource_id=addr'');
