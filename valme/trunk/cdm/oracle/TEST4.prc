CREATE OR REPLACE PROCEDURE CDM.test4  AS 
 BEGIN NULL;
htp.prn('¿');
htp.prn('
');
...
<div id="wrap">
    <div id="title">
        <h1><a href="/" class="textfix">Cuadro de VALME en directo</a></h1>
        <b class="left"></b>
        <b class="right"></b>
    </div>
</div>
    <div>
        <div id="visualization1" style="height: 250px; width: 400px; float: left; margin-left: 150px">
    </div>
    <div>
        <div id="visualization3" style="height: 250px; width: 400px; float: right; margin-right: 150px">
    </div>
</body>
</html>
');
